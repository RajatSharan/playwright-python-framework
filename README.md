...
git clone [https://github.com/your-username/your-repo-name.git](https://github.com/RajatSharan/playwright-python-framework.git)
cd (https://github.com/RajatSharan/playwright-python-framework.git)
